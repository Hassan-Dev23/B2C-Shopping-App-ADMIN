...
import com.example.mystoreadmin.data.di.DataModule_ProvideFirebaseFireStoreFactory;
...
import com.example.mystoreadmin.presentation.viewModel.MyViewModel_HiltModules;
import com.example.mystoreadmin.presentation.viewModel.MyViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.example.mystoreadmin.presentation.viewModel.MyViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
public final class DaggerBaseApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends BaseApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(ImmutableMap.<String, Boolean>of(MyViewModel_HiltModules_KeyModule_Provide_LazyMapKey.lazyClassKeyName, MyViewModel_HiltModules.KeyModule.provide()));
    }
  ...
  private static final class ViewModelCImpl extends BaseApplication_HiltComponents.ViewModelC {
    ...
    Provider<MyViewModel> myViewModelProvider;
    ...
    AddCategoryUseCase addCategoryUseCase() {
      return new AddCategoryUseCase(singletonCImpl.repo());
    }

    AddProductUseCase addProductUseCase() {
      return new AddProductUseCase(singletonCImpl.repo());
    }
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(ImmutableMap.<String, javax.inject.Provider<ViewModel>>of(MyViewModel_HiltModules_BindsModule_Binds_LazyMapKey.lazyClassKeyName, ((Provider) (myViewModelProvider))));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new MyViewModel(viewModelCImpl.addCategoryUseCase(), viewModelCImpl.addProductUseCase(), viewModelCImpl.getAllCategoriesUseCase());
  ...
  private static final class SingletonCImpl extends BaseApplication_HiltComponents.SingletonC {
    ...
    Repo repo() {
      return DomainModule_ProvideRepoFactory.provideRepo(DataModule_ProvideFirebaseFireStoreFactory.provideFirebaseFireStore(), DataModule_ProvideFirebaseStorageFactory.provideFirebaseStorage());
    }
